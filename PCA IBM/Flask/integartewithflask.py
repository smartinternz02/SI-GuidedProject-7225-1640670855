...
API_KEY = "MKvP2YYJ2Hw9e2VuCwRqYKwcaUw-neMjozSK7MNB1xoM"
...
def predict1():
    ...
    response_scoring = requests.post('https://us-south.ml.cloud.ibm.com/ml/v4/deployments/2bb5112f-0f9a-41f6-984f-e78d85d3725b/predictions?version=2022-01-20', json=payload_scoring, headers={'Authorization': 'Bearer ' + mltoken})
